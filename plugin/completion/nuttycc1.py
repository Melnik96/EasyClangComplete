...
def nutty_translate(filename, in_source):
    ...
    e_source = os.popen('gcc -E -I/home/melnik/projects/nutty_lang/pycparser/utils/fake_libc_include/ '+include_dirs+' '+'/tmp/pncc'+os.path.basename(filename)+'.nuti.i').read()
